 ...
 * Last updated: 2025-04-11T19:05:51.658Z
 */
...
export const POST_GENERATION_PROMPT = (article: any, industry: string, topic: string) =>
  `You are Claude 3.7 Sonnet. Write an engaging LinkedIn post as if I am an industry leader in the ${industry} industry, specifically on the topic of ${topic}.
